					...
					switch(this.partie.options.quelTypeBord()){
					  ...
					  case 1: //on regarde pas aprËs les bords
						if (entre(0,nvy,this.tailleY-1) && entre(0,nvx,this.tailleX-1)){
							...
							if (!this.partie.options.yaExplosionJoueur() && autreCase.vaExploser() && autreCase.getJoueur() != cetteCase.getJoueur()){//l'autre case explose de mÍme, et autre joueur : on ne traverse pas, on garde la cellule
								true;
							} else
