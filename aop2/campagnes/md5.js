 ...
 */
/* Ajout d'une classe pour éviter les collisions de noms de variables,
 * par Cédric Mayer, et avec uniquement une fonction visible */
function EcriveurMD5(){
...
this.digere = function MD5(message)
{
...
function md5(message){
	md5.LMD5 = (md5.LMD5?md5.LMD5:new EcriveurMD5());
	return md5.LMD5.digere(message);
}